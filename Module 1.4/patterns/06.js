...
const useClapAnimation = ({
    ...
    useLayoutEffect(() => {
        ...
        // animationTimeline comes from state 
...
/*
This is a new custom hool useDOOMref hook
*/
...
/* 
This should handle the clap state
...
const useClapState = (initialState = INITIAL_STATE) => {
    ...
    // this should be the state updater
...
/*
This is a new hook to calkl a message when the component is mount
*/
...
const useEffectAfterMount = (cb, deps) =>{
    ...
    useEffect(() => {
        ...
        // eslint-dissable-next line react-hooks/exhasutive-deps
      }, deps)
}
...
const MediumClap = () => {
    ...
    // this is the only change we have done so far in order to de-construct component in smaller pieces
