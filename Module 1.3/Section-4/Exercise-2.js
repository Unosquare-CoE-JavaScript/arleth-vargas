// we need to gather the posts, comments from jsonplaceholder. 
// we need to make them accessible from outside 
var MAINAPP = (function(nsp) {
    ...
    */
    ...
    // we have catch in case we get an error when trying to get the data and we can show a message
    fetch(url + 'posts/')
...
All of them are accessible from outside and the data is attached to MAINAPP
*/